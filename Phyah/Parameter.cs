...
namespace Phyah
{
    ...
    public class Parameter : DynamicObject, IParameter//,IEnumerable<object>,IEnumerator<object>
    {
        ...
        public IParameter Merge(IDictionary<string, object> keyvaluePairs)
        {
        ...
        public IParameter Merge(ICollection<KeyValuePair<string, object>> keyvaluePairs)
        {
        ...
        public IParameter Merge(IEnumerable<KeyValuePair<string, object>> keyvaluePairs)
        {
        ...
        public IParameter Merge<T>(IDictionary<string, T> keyvaluePairs)
        {
        ...
        public IParameter Merge<T>(ICollection<KeyValuePair<string, T>> keyvaluePairs)
        {
            foreach (var keyvalue in keyvaluePairs)
            {
                this[keyvalue.Key] = keyvalue.Value;
        ...
        public IParameter Merge<T>(IEnumerable<KeyValuePair<string, T>> keyvaluePairs)
        {
            foreach (var keyvalue in keyvaluePairs)
            {
                this[keyvalue.Key] = keyvalue.Value;
